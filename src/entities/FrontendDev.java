...
public class FrontendDev extends Employee implements IProgrammer_member {
    ...
    public FrontendDev(int EmpId, String Name, String address, String status, String level, String Department) {
